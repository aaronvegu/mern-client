  ...
  return async (dispatch, getState) => {
    try {
      ...
      const { isValid, errors } = allFieldsValidation(newCategory, rules, {
        ...
        'required.description': 'La descripcion es requerida.',
        'max.description':
          'La descripcion no debe contener mas de 200 caracteres.',
        'required.products': 'Los productos son requeridos.',
      });
...
export const updateCategory = () => {
  return async (dispatch, getState) => {
    try {
      ...
      const { isValid, errors } = allFieldsValidation(newCategory, rules, {
        'required.name': 'El nombre es requerido.',
        'required.slug': 'Slug es requerido.',
        'alpha_dash.slug':
          'Slug debe contener caracteres alfanumericos, asi como guiones solamente.',
        'required.description': 'La descripcion es requerida.',
        'max.description':
          'La descripcion no debe contener mas de 200 caracteres.',
        'required.products': 'El producto es requerido.',
      });
