...
const Footer = () => {
  const infoLinks = [
    ...
    { id: 1, name: 'Vende con nosotros', to: '/sell' },
        ...
        <div className='footer-content'>
          <div className='footer-block'>
            <div className='block-title'>
              <h3 className='text-uppercase'>Servicio al cliente</h3>
            </div>
          ...
          <div className='footer-block'>
            <div className='block-title'>
              <h3 className='text-uppercase'>Noticias</h3>
              <Newsletter />
            </div>
          </div>
        </div>
        <div className='footer-copyright'>
          <span>© {new Date().getFullYear()} Agencia de Autos</span>
        </div>
